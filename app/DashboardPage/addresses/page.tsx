...
export default function AddressesPage() {
  ...
  // Sample provinces and cities for Iran - COMPLETELY UPDATED WITH ALL PROVINCES
  const provinces = [
  ...
  // COMPLETE CITIES OBJECT FOR ALL IRANIAN PROVINCES
  const cities = {
    "تهران": ["تهران", "شهریار", "اسلامشهر", "رباط کریم", "پاکدشت", "قدس", "ری", "ورامین"],
    "اصفهان": ["اصفهان", "کاشان", "خمینی شهر", "نجف آباد", "شاهین شهر", "زرین شهر", "فلاورجان", "مبارکه"],
    "فارس": ["شیراز", "مرودشت", "کازرون", "فسا", "لار", "جهرم", "سپیدان", "داراب"],
    "خراسان رضوی": ["مشهد", "نیشابور", "سبزوار", "تربت حیدریه", "قوچان", "تربت جام", "کاشمر", "چناران"],
    "آذربایجان شرقی": ["تبریز", "مراغه", "مرند", "اهر", "سراب", "میانه", "اسکو", "آذرشهر"],
    "آذربایجان غربی": ["ارومیه", "خوی", "مهاباد", "میاندوآب", "سلماس", "پیرانشهر", "اشنویه", "بوکان"],
    "کرمان": ["کرمان", "رفسنجان", "سیرجان", "بم", "زرند", "جیرفت", "کهنوج", "انار"],
    "خوزستان": ["اهواز", "آبادان", "خرمشهر", "دزفول", "شوشتر", "رامهرمز", "بهبهان", "اندیمشک"],
    "قزوین": ["قزوین", "البرز", "آبیک", "بوئین زهرا", "تاکستان", "آوج"],
    "قم": ["قم"],
    "البرز": ["کرج", "هشتگرد", "نظرآباد", "طالقان", "اشتهارد", "فردیس"],
    "گیلان": ["رشت", "انزلی", "لاهیجان", "آستارا", "تالش", "فومن", "صومعه سرا", "رودسر"],
    "مازندران": ["ساری", "بابلسر", "آمل", "قائم شهر", "نکا", "بهشهر", "تنکابن", "رامسر"],
    "مرکزی": ["اراک", "ساوه", "خمین", "محلات", "دلیجان", "تفرش", "شازند", "زرندیه"],
    "همدان": ["همدان", "ملایر", "نهاوند", "تویسرکان", "کبودرآهنگ", "اسدآباد", "بهار", "رزن"],
    "کردستان": ["سنندج", "سقز", "مریوان", "قروه", "بیجار", "کامیاران", "دهگلان", "بانه"],
    "لرستان": ["خرم آباد", "بروجرد", "دورود", "کوهدشت", "الیگودرز", "ازنا", "پلدختر", "سلسله"],
    "سیستان و بلوچستان": ["زاهدان", "زابل", "چابهار", "ایرانشهر", "خاش", "سراوان", "نیکشهر", "کنارک"],
    "یزد": ["یزد", "میبد", "اردکان", "بافق", "مهریز", "تفت", "اشکذر", "بهاباد"],
    "کرمانشاه": ["کرمانشاه", "اسلام آباد غرب", "هرسین", "کنگاور", "سنقر", "جوانرود", "قصر شیرین", "پاوه"],
    "اردبیل": ["اردبیل", "خلخال", "مشگین شهر", "گرمی", "نیر", "نمین", "پارس آباد", "بیله سوار"],
    "بوشهر": ["بوشهر", "برازجان", "خارک", "گناوه", "دیلم", "کنگان", "عسلویه", "جم"],
    "زنجان": ["زنجان", "ابهر", "خدابنده", "طارم", "ماهنشان", "سلطانیه", "ایجرود", "خرمدره"],
    "سمنان": ["سمنان", "شاهرود", "دامغان", "گرمسار", "آرادان", "مهدی شهر", "میامی", "سرخه"],
    "چهارمحال و بختیاری": ["شهرکرد", "بروجن", "لردگان", "اردل", "فارسان", "کیار", "سامان", "بن"],
    "هرمزگان": ["بندرعباس", "قشم", "بندر لنگه", "میناب", "رودان", "جاسک", "حاجی آباد", "بستک"],
    "کهگیلویه و بویراحمد": ["یاسوج", "گچساران", "دهدشت", "لیکک", "چرام", "باشت", "سی سخت", "پاتاوه"],
    "گلستان": ["گرگان", "گنبد کاووس", "علی آباد", "مینودشت", "آزادشهر", "رامیان", "کردکوی", "بندر گز"],
    "ایلام": ["ایلام", "دهلران", "آبدانان", "مهران", "دره شهر", "ایوان", "شیروان و چرداول", "ملکشاهی"],
    "خراسان شمالی": ["بجنورد", "اسفراین", "شیروان", "آشخانه", "فاروج", "گرمه", "جاجرم", "راز و جرگلان"],
    "خراسان جنوبی": ["بیرجند", "قائن", "فردوس", "نهبندان", "سربیشه", "درمیان", "سرایان", "خوسف"]
  };
