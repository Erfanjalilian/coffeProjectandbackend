...
export default function ArticleDetailPage() {
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white pt-24" dir="rtl">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="animate-pulse">
            ...
            <div className="h-4 bg-blue-100 rounded w-1/2 mb-8"></div>
  ...
  if (error || !article) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white pt-24 flex items-center justify-center" dir="rtl">
        <div className="text-center">
          <div className="bg-white rounded-2xl shadow-lg border-2 border-blue-200 p-8 max-w-md mx-auto">
            <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg className="w-8 h-8 text-[#3366FF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-[#333333] mb-4 font-[var(--font-yekan)]">
              متاسفانه مقاله مورد نظر شما در دسترس نیست.
            </p>
            <Link
              href="/articles"
              className="bg-[#3366FF] hover:bg-[#194FFF] text-white px-6 py-2 rounded-xl font-semibold transition-colors font-[var(--font-yekan)] inline-block"
            >
              بازگشت به مقالات
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white pt-34" dir="rtl">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.div
          ...
          className="text-sm text-[#333333] mb-6 font-[var(--font-yekan)] flex items-center gap-2"
        >
          ...
          <span>/</span>
          <span className="text-[#3366FF] font-semibold">{article.title}</span>
        </motion.div>

        {/* Article Header - Updated with brand colors */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          {/* Article Meta - Updated with brand colors */}
        ...
        {/* Article Cover - Updated with brand colors */}
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl p-12 mb-8 flex items-center justify-center border-2 border-blue-300"
        >
          <div className="text-center">
        ...
        {/* Article Body - Updated with brand colors */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          {/* Article Actions - Updated with brand colors */}
          <div className="flex flex-wrap items-center gap-4 mt-8 pt-6 border-t border-gray-200">
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 bg-blue-50 text-[#3366FF] px-4 py-2 rounded-xl font-[var(--font-yekan)] hover:bg-blue-100 transition-colors"
            >
              <FiBookmark />
              ذخیره مقاله
            </motion.button>
        ...
        {/* Related Products Section - Updated with brand colors */}
              ...
              {relatedProducts.map((product, index) => (
                ...
                >
                  <motion.div
                    ...
                    className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border-2 border-blue-200 hover:border-[#3366FF] transition-all group cursor-pointer h-full"
                  >
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="bg-blue-100 text-[#3366FF] text-xs px-2 py-1 rounded-full font-[var(--font-yekan)]">
                        {product.brand || 'برند'}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="bg-[#3366FF] hover:bg-[#194FFF] text-white px-4 py-2 rounded-xl font-semibold text-sm font-[var(--font-yekan)] transition-colors"
                        onClick={(e) => {
                          e.preventDefault();
